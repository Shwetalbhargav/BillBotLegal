...
export const { reducer: associateProfileReducer, actions: associateProfileActions, thunks: associateProfileThunks } = buildProfileSlice('associateProfile', associateProfiles);
