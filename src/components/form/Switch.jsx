...
return (
<label className={clsx("lb-reset inline-flex items-center gap-3 select-none", className)}>
<button
type="button"
role="switch"
...
checked ? "bg-[color:var(--lb-primary-600)]" : "bg-[color:var(--lb-bg)]",
...
{label && <span className="text-[var(--lb-fs-sm)] text-[color:var(--lb-text)]">{label}</span>}
</label>
);
}