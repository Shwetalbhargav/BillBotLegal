// src/pages/BillablesPage.jsx — API‑integrated
...
const hoursOf = (b) => typeof b.durationHours === "number" ? b.durationHours : (Number(b.durationMinutes || 0) / 60);
...
export default function BillablesPage() {
  ...
  const rows = useMemo(() => {
    ...
    if (q.trim()) {
      ...
      r = r.filter((b) =>
        ...
        String((typeof b.caseId === "object" ? b.caseId?.name : b.caseId) || "").toLowerCase().includes(t)
      );
    }
  ...
  const onPrint = () => {
    ...
    tag.innerHTML = css; document.head.appendChild(tag); window.print(); setTimeout(() => tag.remove(), 0);
  };
    ...
    <div className="lb-reset p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Switch checked={showUnbilledOnly} onChange={setShowUnbilledOnly} />
        </div>
      </div>
